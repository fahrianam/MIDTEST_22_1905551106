							...
							<div class="col-xs-12">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="/matakuliah/{{$mk->id}}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btn-info" onclick="location.href='/matakuliah/{{$mk->id}}'">View</button>
                                                            <button type="button" class="btn btn-info" onclick="location.href='/matakuliah/{{$mk->id}}/edit'">Edit</button>
                                ...
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button class="btn btn-success" type="button" onclick="location.href='/matakuliah/create'">
