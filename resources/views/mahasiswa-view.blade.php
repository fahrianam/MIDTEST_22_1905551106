				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form  action="/mahasiswa/{{$mahasiswa->id}}" method="POST" class="form-horizontal" role="form" novalidate>
									@csrf
                                    @method('PUT')
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Masukkan Nama Anda" class="col-xs-10 col-sm-5" id="nama" name="nama" readonly value="{{$mahasiswa->nama_mahasiswa}}" required/>
										</div>
									</div>

                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> NIM </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan NIM Anda" class="col-xs-10 col-sm-5" id="nim" name="nim" readonly value="{{$mahasiswa->NIM}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-4" id="form-field-1-1" id="jenis_kelamin" name="jenis_kelamin" disabled>
                                                <option value=""></option>
                                                <option value="Pria" @if($mahasiswa->jenis_kelamin == 'Pria') selected='selected' @endif>Pria</option>
                                                <option value="Wanita" @if($mahasiswa->jenis_kelamin == 'Wanita') selected='selected' @endif>Wanita</option>
                                            </select>
                                        </div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="date" class="col-xs-10 col-sm-5" id="form-field-1-1" placeholder="Masukkan Tanggal Lahir Anda" class="form-control" id="tanggal_lahir" name="tanggal_lahir" readonly value="{{$mahasiswa->tanggal_lahir}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan Alamat Anda" class="col-xs-10 col-sm-5" id="alamat" name="alamat" readonly value="{{$mahasiswa->alamat}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Masukkan No.Telp Anda" class="col-xs-10 col-sm-5" id="telepon" name="telepon" readonly value="{{$mahasiswa->no_telp}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan Email Anda" class="col-xs-10 col-sm-5" id="email" name="email" readonly value="{{$mahasiswa->email}}" required/>
										</div>
									</div>

                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Dosen Pembimbing </label>
                                        <div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-5" id="form-field-1-1" id="dosen_pembimbing" name="dosen_pembimbing" disabled>
                                                @foreach($dosen as $d)
                                                    <option value="{{$d->id}}" @if($d->id == $mahasiswa->dosen_id)
                                                        SELECTED
                                    ...
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Pilihan Mata Kuliah </label>
										<div class="col-sm-9">
                                            @foreach($mata_kuliah as $mk)
                                                <div class="checkbox">
													<label>
														<input value="{{$mk->id}}" name="mata_kuliah_id[]" type="checkbox" class="ace"  
                                                            @if(in_array($mk->id,$matkul_pilihan_mahasiswa))
                                                                CHECKED
                                                            @endif
                                                        disabled />
														<span class="lbl"> {{$mk->nama_mata_kuliah}} </span>
													</label>
												</div>
                                            @endforeach
										</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
                                            &nbsp; &nbsp; &nbsp;
                                            <button class="btn btn-danger" type="button" onclick="location.href='/mahasiswa'">
