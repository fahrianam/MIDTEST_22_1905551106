							...
							<div class="col-xs-12">
								...
								<form  action="/mahasiswa/{{$mahasiswa->id}}" method="POST" class="form-horizontal" role="form" novalidate>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Masukkan Nama Anda" class="col-xs-10 col-sm-5" id="nama" name="nama" value="{{$mahasiswa->nama_mahasiswa}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan NIM Anda" class="col-xs-10 col-sm-5" id="nim" name="nim" value="{{$mahasiswa->NIM}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-4" id="form-field-1-1" id="jenis_kelamin" name="jenis_kelamin">
                                                <option value=""></option>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="date" class="col-xs-10 col-sm-5" id="form-field-1-1" placeholder="Masukkan Tanggal Lahir Anda" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{$mahasiswa->tanggal_lahir}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan Alamat Anda" class="col-xs-10 col-sm-5" id="alamat" name="alamat" value="{{$mahasiswa->alamat}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Masukkan No.Telp Anda" class="col-xs-10 col-sm-5" id="telepon" name="telepon" value="{{$mahasiswa->no_telp}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan Email Anda" class="col-xs-10 col-sm-5" id="email" name="email" value="{{$mahasiswa->email}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-5" id="form-field-1-1" id="dosen_pembimbing" name="dosen_pembimbing">
                                                @foreach($dosen as $d)
