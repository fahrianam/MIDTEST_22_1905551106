							...
							<div class="col-xs-12">
								...
								<form  action="/dosen/{{$dosen->id}}" method="POST" class="form-horizontal" role="form" novalidate>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Masukkan Nama Anda" class="col-xs-10 col-sm-5" id="nama" name="nama" readonly value="{{$dosen->nama_dosen}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan NIK Anda" class="col-xs-10 col-sm-5" id="nik" name="nik" readonly value="{{$dosen->NIK}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="date" class="col-xs-10 col-sm-5" id="form-field-1-1" placeholder="Masukkan Tanggal Lahir Anda" class="form-control" id="tanggal_lahir" name="tanggal_lahir" readonly value="{{$dosen->tanggal_lahir}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan Alamat Anda" class="col-xs-10 col-sm-5" id="alamat" name="alamat" readonly value="{{$dosen->alamat}}" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Masukkan No.Telp Anda" class="col-xs-10 col-sm-5" id="telepon" name="telepon" readonly value="{{$dosen->no_telp}}" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan Email Anda" class="col-xs-10 col-sm-5" id="email" name="email" readonly value="{{$dosen->email}}" required/>
										</div>
									</div>
