				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form  action="/matakuliah" method="POST" class="form-horizontal" role="form">
									@csrf
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Mata Kuliah</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Masukkan Nama Mata Kuliah" class="col-xs-10 col-sm-5" id="nama_mata_kuliah" name="nama_mata_kuliah" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Masukkan Nilai SKS" class="col-xs-10 col-sm-3" id="sks" name="sks" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="time" id="form-field-1-1" placeholder="Masukkan Jam Mulai" class="col-xs-10 col-sm-3" id="jam_mulai" name="jam_mulai" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="time" id="form-field-1-1" placeholder="Masukkan Jam Mulai" class="col-xs-10 col-sm-3" id="jam_akhir" name="jam_akhir" required/>
										</div>
									</div>
