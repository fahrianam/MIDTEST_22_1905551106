...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>DASHBOARD SISTEM KRS MAHASISWA</title>
				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="page-header">
							<h1>
								DASHBOARD SISTEM KRS MAHASISWA
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-block alert-success">
									...
									<strong class="green">
                                    SELAMAT DATANG DI DASHBOARD KRS MAHASISWA 
									<p></p>
									Dashboard ini berguna untuk melayani mahasiswa yang ingin melakukan pemilihan untuk mata kuliah.
									Diharapkan dashboard ini dapat memudahkan proses dalam pemilihan mata kuliah mahasiswa. Selain itu dashboard ini juga
									melayani dan menyediakan informasi data diri dari dosen-dosen yang mengajar berbagai macam mata kuliah.
									</strong>
...
<![endif]-->
		...
		<script src="{{ asset('style/assets/js/jquery.sparkline.index.min.js')}}"></script>
		<script src="{{ asset('style/assets/js/jquery.flot.min.js')}}"></script>
		<script src="{{ asset('style/assets/js/jquery.flot.pie.min.js')}}"></script>
		<script src="{{ asset('style/assets/js/jquery.flot.resize.min.js')}}"></script>
